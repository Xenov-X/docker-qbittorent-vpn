...
TRANSMISSION_CONTROL_OPTS="--script-security 2 --up-delay --up /usr/share/openrc/support/openvpn/up.sh --up /etc/openvpn/tunnelUp.sh --down /usr/share/openrc/support/openvpn/down.sh --down /etc/openvpn/tunnelDown.sh"
